...
public class SimpleSamlAssertionConsumer implements SamlAssertionConsumer {
    ...
    private java.security.PublicKey extractPublicKey(Signature signature) throws CertificateException {
